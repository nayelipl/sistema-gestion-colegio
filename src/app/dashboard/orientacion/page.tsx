...
const s: Record<string, React.CSSProperties> = {
  ...
  tipoBadge:    { background: "#F3E8FF", color: "#C0392B", borderRadius: "12px", padding: "3px 10px", fontSize: "11px", fontWeight: "bold", display: "inline-block", marginBottom: "8px" },
  pubTitulo:    { fontSize: "16px", fontWeight: "bold", color: "#2C1810", margin: "0 0 4px" },
