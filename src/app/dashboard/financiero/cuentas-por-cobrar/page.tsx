...
const s: Record<string, React.CSSProperties> = {
  ...
  btnFiltrar: { background: "#1F5C99", color: "#fff", border: "none", borderRadius: "6px", padding: "9px 16px", cursor: "pointer", marginRight: "8px" },
  btnActualizar: { background: "#2F855A", color: "#fff", border: "none", borderRadius: "6px", padding: "9px 16px", cursor: "pointer" },
  totalesCard: { background: "linear-gradient(135deg, #1F5C99, #5D2F7D)", color: "#fff", borderRadius: "12px", padding: "16px 20px", marginBottom: "20px", display: "flex", justifyContent: "space-between" },
