...
const s: Record<string, React.CSSProperties> = {
  ...
  tutorNombre: { fontSize: "14px", fontWeight: "bold", color: "#2C1810" },
  balanceCard: { background: "#2C1810", color: "#fff", borderRadius: "12px", padding: "12px 20px", marginTop: "16px", textAlign: "center", fontSize: "14px" },
