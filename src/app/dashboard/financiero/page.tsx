...
const s: Record<string, React.CSSProperties> = {
  ...
  resumenValor:  { fontSize: "22px", fontWeight: "bold", color: "#2C1810", margin: 0 },
  ...
  badgePresencial:{ background: "#EBF3FB", color: "#2C1810", borderRadius: "12px", padding: "3px 10px", fontSize: "11px", fontWeight: "bold" },
  badgeOnline:   { background: "#F3E8FF", color: "#C0392B", borderRadius: "12px", padding: "3px 10px", fontSize: "11px", fontWeight: "bold" },
};
