...
const s: Record<string, React.CSSProperties> = {
  loading: { minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "16px", color: "#1F5C99" },
  ...
  enlace: { color: "#1F5C99", fontWeight: "bold", textDecoration: "none" },
  ...
  btnPrimary: { background: "linear-gradient(135deg,#1F5C99,#5D2F7D)", color: "#fff", border: "none", borderRadius: "8px", padding: "10px 20px", fontSize: "14px", fontWeight: "bold", cursor: "pointer" },
  btnSecundario: { background: "#1F5C99", color: "#fff", border: "none", borderRadius: "6px", padding: "8px 16px", fontSize: "13px", cursor: "pointer" },
  ...
  rutaNombre: { fontSize: "18px", fontWeight: "bold", color: "#1F5C99", margin: 0 },
  ...
  btnEditar: { background: "#1F5C99", color: "#fff", border: "none", borderRadius: "6px", padding: "6px 12px", fontSize: "12px", cursor: "pointer" },
  ...
  statCardMonto: { background: "#EBF3FB", borderRadius: "10px", padding: "12px 20px", textAlign: "center", color: "#1F5C99" },
  ...
  btnFiltrar: { background: "#1F5C99", color: "#fff", border: "none", borderRadius: "6px", padding: "8px 16px", cursor: "pointer" },
  ...
  th: { padding: "10px 12px", color: "#1F5C99", fontSize: "11px", fontWeight: "bold", textAlign: "left" as any, borderBottom: "2px solid #ddd" },
  ...
  btnAgregarPunto: { background: "#1F5C99", color: "#fff", border: "none", borderRadius: "6px", padding: "8px 16px", cursor: "pointer" },
  ...
  modalTitulo: { fontSize: "20px", fontWeight: "bold", color: "#1F5C99", marginBottom: "20px" },
  ...
  btnGuardar: { background: "#1F5C99", color: "#fff", border: "none", borderRadius: "6px", padding: "10px 20px", cursor: "pointer" },
  ...
  vincularTitulo: { fontSize: "18px", fontWeight: "bold", color: "#1F5C99", margin: "0 0 8px" },
  ...
  btnVincular: { background: "linear-gradient(135deg,#1F5C99,#5D2F7D)", color: "#fff", border: "none", borderRadius: "8px", padding: "14px 24px", fontSize: "16px", fontWeight: "bold", cursor: "pointer", marginTop: "16px" },
  ...
  navInfo: { fontSize: "14px", fontWeight: "bold", color: "#1F5C99", minWidth: "200px", textAlign: "center" },
  subtituloTabla: { fontSize: "16px", fontWeight: "bold", color: "#1F5C99", margin: "20px 0 12px 0", paddingBottom: "6px", borderBottom: "2px solid #1F5C99", },
};
