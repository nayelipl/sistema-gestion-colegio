...
const s: Record<string, React.CSSProperties> = {
  ...
  seccionTitulo: {  fontSize: "16px", fontWeight: "bold", color: "#2C1810", margin: "0 0 16px 0", paddingBottom: "8px", borderBottom: "2px solid #1F5C99", display: "inline-block", },
  ...
  btnNuevo:   { background: "linear-gradient(135deg,#2C1810,#4a2518)", color: "#fff", border: "none", borderRadius: "6px", padding: "8px 16px", fontSize: "13px", cursor: "pointer" },
