...
const s: Record<string, React.CSSProperties> = {
  ...
  inscripcionNo: { fontWeight: "bold", color: "#1F5C99", fontSize: "14px" },
  ...
  seccionTitulo: { fontSize: "15px", fontWeight: "bold", color: "#1F5C99", margin: "0 0 16px 0", borderBottom: "2px solid #1F5C99", paddingBottom: "6px", display: "inline-block" },
  ...
  btnGuardar: { background: "linear-gradient(135deg,#1F5C99,#5D2F7D)", color: "#fff", border: "none", borderRadius: "8px", padding: "10px 24px", fontSize: "14px", fontWeight: "bold", cursor: "pointer" },
  ...
  modalTitulo: { fontSize: "18px", fontWeight: "bold", color: "#1F5C99", margin: 0 },
  ...
  btnVer: { background: "#EBF3FB", color: "#1F5C99", border: "none", borderRadius: "4px", padding: "4px 10px", cursor: "pointer", fontSize: "12px" },
};