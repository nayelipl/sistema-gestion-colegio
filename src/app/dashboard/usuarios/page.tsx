            ...
            {contrasenaTemp ? (
              <div style={{ textAlign: "center" }}>
                ...
                <div style={s.contrasenaBox}>
                  ...
                  <code style={{ fontSize: "22px", fontWeight: "bold", color: "#1F5C99", letterSpacing: "2px" }}>
                    {contrasenaTemp}
                  </code>
...
const s: Record<string, React.CSSProperties> = {
  ...
  badge:       { background: "#1F5C99", color: "#fff", borderRadius: "10px", padding: "2px 8px", fontSize: "11px" },
  ...
  rolBadge:    { background: "#F3E8FF", color: "#5D2F7D", borderRadius: "12px", padding: "3px 10px", fontSize: "11px", fontWeight: "bold" },
  codigo:      { background: "#f0f4f8", padding: "2px 8px", borderRadius: "4px", fontSize: "12px", fontFamily: "monospace" },
  btnEditar:   { background: "#EBF3FB", color: "#1F5C99", border: "none", borderRadius: "6px", padding: "5px 10px", fontSize: "12px", cursor: "pointer" },
