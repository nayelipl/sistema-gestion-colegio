...
const s: Record<string, React.CSSProperties> = {
  ...
  statValor:    { fontSize: "28px", fontWeight: "bold", color: "#2C1810", margin: "0 0 4px" },
  statLabel:    { fontSize: "12px", color: "#666", margin: 0 },
  seccionTitulo:{ fontSize: "15px", fontWeight: "bold", color: "#2C1810", margin: "0 0 16px" },
  ...
  accionTitulo: { fontSize: "14px", fontWeight: "bold", color: "#2C1810", margin: "0 0 6px" },
  ...
  btnAccion:    { background: "#EBF3FB", color: "#2C1810", border: "none", borderRadius: "6px", padding: "8px 16px", fontSize: "13px", cursor: "pointer", fontWeight: "600", textDecoration: "none", display: "inline-block" },
