...
const styles: Record<string, React.CSSProperties> = {
  ...
  seccionTitulo: { fontSize: "16px", fontWeight: "bold", color: "#2C1810", margin: "0 0 16px", borderBottom: "2px solid #1F5C99", paddingBottom: "8px" },
  ...
  btnGuardar: { background: "linear-gradient(135deg, #2C1810, #4a2518)", color: "#fff", border: "none", borderRadius: "8px", padding: "14px 28px", fontSize: "16px", fontWeight: "bold", cursor: "pointer" },
  ...
  btnGuardarCuotas: { background: "#2C1810", color: "#fff", border: "none",  borderRadius: "6px",  padding: "10px 20px",  fontSize: "14px",  fontWeight: "bold",  cursor: "pointer",  marginTop: "16px", },
};
